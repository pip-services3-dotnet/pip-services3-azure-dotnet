...
{
    public class ServiceBusMessageTopicV2 : MessageQueue
    {
        ...
        public ServiceBusMessageTopicV2() 
            : this(null)
        {
        }

        public ServiceBusMessageTopicV2(string name = null)
        {
            Name = name;
            Capabilities = new MessagingCapabilities(false, true, true, true, true, true, true, true, true);
        }

        public ServiceBusMessageTopicV2(string name, ConfigParams config)
            : this(name)
        {
            if (config != null)
            {
